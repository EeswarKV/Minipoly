...
function NotifyStack({ navigation }) { 
    return (
    <Stack.Navigator >
...
function WishStack({ navigation }) { 
    return (
    <Stack.Navigator >
        <Stack.Screen name="Wish" component={WishScreen} options={{
                    drawerLabel: () => null,
                    headerLeft: (props) => (
                        <Icon
                            name="md-menu"
...
function NotificationsScreen({ navigation }) {
    return (
        <Tab.Navigator tabBarOptions={{
            ...
            <Tab.Screen name="Notifications" component={NotifyStack} />
            ...
            <>
                <NavigationContainer>
                    ...
                    >
                        ...
                        <Drawer.Screen name="Greetings" component={WishScreen} />
                    </Drawer.Navigator>
                </NavigationContainer>
